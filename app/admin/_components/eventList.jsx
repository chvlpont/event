...
function EventList({ searchTerm }) {
    // Placeholder data
    const events = [
      { id: 1, category: 'Music', title: 'Music Festival', date: '2024-06-01', location: 'Central Park, New York', description: 'Join us for a day of amazing music and fun!', registrants: 4500, limit: 5000, image: 'https://images.pexels.com/photos/1190297/pexels-photo-1190297.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' },
      { id: 2, category: 'Art', title: 'Art Exhibition', date: '2024-07-30', location: 'Modern Art Museum, San Francisco', description: 'Experience the best of contemporary art at our annual exhibition.', registrants: 200, limit: 200, image: 'https://images.pexels.com/photos/1190297/pexels-photo-1190297.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' },
      { id: 3, category: 'Tech', title: 'Tech Conference', date: '2024-08-03', location: 'Convention Center, Austin', description: 'The biggest tech conference of the year. Don\'t miss it!', registrants: 800, limit: 1000, image: 'https://images.pexels.com/photos/1190297/pexels-photo-1190297.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' },
        // Add more events...
    ];
    ...
    const handleEditClick = (event) => {
      if (process.browser) { // ensures this code is only run in the browser where document is available
